  ...
  return (
    <div className="">
      ...
      <div className="w-full lg:w-1/2">
        ...
        <div className="w-full lg:w-1/2">
          <h1 className="text-center  mt-10 lg:-mt-5 text-[25px] 2xl:text-[35px] font-semibold 2xl:mt-20">
            Hello Again!
          </h1>
          <p className="text-center text-[#A4A4A4] 2xl:mt-8">
          ...
          <div className="px-10 lg:px-28 2xl:px-48">
            ...
            <div className="flex mt-3">
              ...
              <p className="text-[#A4A4A4]">
                I’ve read and agree with terms of service and <br /> our Privacy
                Police
              </p>
            </div>
            <button className="w-full mt-3 text-center text-white font-medium py-2 2xl:py-3 bg-gradient-to-r from-[#3092DD] to-[#40F8FF] rounded-lg">
              Sign Up
            </button>
            <div className="mt-2 2xl:mt-5">
              <button className="flex justify-center w-full py-2 2xl:py-2 px-4 rounded-lg bg-[#EFEFEF]/20 border">
                <img src={GoogleLogo} className="h-6 2xl:h-8 2xl:w-8 mr-3" />
                <h1 className=" text-[#A4A4A4]">Sign Up With Google</h1>
              </button>
            </div>
            <p className="text-[#A4A4A4] py-5 lg:py-3 text-center lg:mt-3 2xl:mt-28">
              Already have an Account? 
              {signin.map((link, index) => (
                <a
                  onClick={() => navigate("/Login")}
                  href={link.link}
                  className="text-[#3F96DC]"
                > Sign in
                </a>
              ))}
            </p>
